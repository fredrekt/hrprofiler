	...
	<div class="container mt-4">
			<div class="jumbotron card card-image" style="background-image: url(https://mdbootstrap.com/img/Photos/Others/gradient1.jpg);">
			  <div class="text-white text-center py-5 px-4">
			    <div>
			      <h2 class="card-title h1-responsive pt-3 mb-5 font-bold"><strong>EMPLOYEE ONBOARDING</strong></h2>
			      <p class="mx-5 mb-5">
					...
					<a type="button" href="/onboarding" class="btn btn-outline-light">Get Started</a>
			    </div>
			  </div>
			</div>
	</div>
		...
		<div class="container">
			<div class="jumbotron">
			  ...
			  <div class="text-center">
			  	<a class="btn btn-primary btn-lg" href="#" role="button">Update information</a>
			  </div>
			</div>
		</div>
		...
		<div class="card card-image" style="background-image: url(https://www.oodlesthemes.com/wp-content/uploads/2017/10/590x300-OO0122316-Red-abstract-background-design-vector.jpg);">
		  <div class="text-white text-center rgba-white-slight py-5 px-4">
		    <div class="py-5">
		      ...
		      <!-- Content -->
		      <h2 class="card-title h2 my-4 py-2">EMPLOYEE OFFBOARDING</h2>
		      ...
		      <a style="color:white;" class="btn btn-outline-white waves-effect"><i class="fas fa-clone left"></i> FIRE EMPLOYEES</a>
