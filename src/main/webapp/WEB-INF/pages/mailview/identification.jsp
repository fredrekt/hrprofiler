...
<body style="background:url(https://netbramha.com/wp-content/uploads/2016/12/senior-front-end-developer-openings-1.gif);background-repeat:no-repeat; background-position: 800px 154px">
  ...
  <div class="bs-stepper-header" role="tablist">
    ...
    <div class="line"></div>
    <div id="add-active-class-3" class="step1 active" data-target="#logins-part">
      <button disabled onclick="showStepOne()" type="button" class="step-trigger" role="tab" aria-controls="logins-part" id="logins-part-trigger">
        <span id="bs-num1" class="fas fa-check-circle text-success fa-2x"></span>
        <span class="bs-stepper-label">Training & Orientation</span>
      </button>
    </div>
    <div class="line"></div>
    <div id="add-active-class-4" class="step active" data-target="#logins-part">
      <button onclick="showStepTwo()" type="button" class="step-trigger" role="tab" aria-controls="logins-part" id="bankBtn">
    ...
    <div id="add-active-class-5" class="step" data-target="#logins-part">
      <button onclick="showSmtpThree()" type="button" class="step-trigger" role="tab" aria-controls="logins-part" id="logins-part-trigger">
  ...
  <div class="bs-stepper-content">
    ...
    <div style="display:none" class="step1-content" id="smtp2-content">
    	<div class="container">
    		<form method="get" action="/send-mail2?EmpID=${$empid }">
		    <h3 class="content-header mt-3">
		    Employee Identification Processing
		    </h3>
		    <input name="EmpID" hidden value="${empid }" type="text"/>
		    <p class="grey-text">Onboarding process will be sent to the department</p>
		  	<div style="margin-left:5%">
		  		<img src="data:image/png;base64,">
		    </div>
    ...
    <div style="display:inline" id="step2-content">
    	<div class="container">
		    <h3 class="content-header mt-3">
		    ...
		    <div id="container-area" class="container-area">
			    ...
			    <div class="id-name">${employee.getLastName()}, ${employee.getFirstName()}</div>
			    <div class="id-job">${employee.getDesignation() }</div>
...
<!-- Footer Ends-->
	...
	<script>
	window.alert("Note: Company Identification status that has been sent, has been approved! Employee can now be prepared for his or her Company Identification!")
	</script>
