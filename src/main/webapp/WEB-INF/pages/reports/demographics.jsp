...
<!-- MDB CDN ENDS -->
    ...
    <link href="https://fonts.googleapis.com/css?family=Oswald&display=swap" rel="stylesheet">
      ...
      <div style="" id="content" class="p-4 p-md-5 pt-5">
        <h2 style="margin-top:-3%" class="mb-4">Employee Demographics</h2>
        <p class="grey-text">Below are the generated reports for the employees</p>
        <form action="" method="">
        <h4 class="">
        	Report for existing male employees
        </h4>
        <a href="/generate-all-male"></a>
        	<table id="container-area" class="table table-hover">
			  <thead>
			    <tr>
...
-			    </tr>
			...
			<button onclick="printID()" class="btn btn-sm btn-info">
				export table
			</button>
